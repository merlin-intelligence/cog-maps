...
from cogmaps.config import MAX_CHUNKS_FOR_CONTEXT, NEIGHBORS_TO_FETCH
...
def explore_graph_for_context(
    ...
    while frontier and len(collected_ids) < max_chunks:
        ...
        try:
            ...
            logger.warning(
                "BFS expansion from point %s failed; continuing with a partial graph.",
                current_id, exc_info=True,
            )
